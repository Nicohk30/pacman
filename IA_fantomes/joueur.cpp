...
void Joueur::interactionTunnelHorizontaux(const TunnelHorizontal& t, sf::Sprite& sprite, int TAILLE_ENTITE, float AGRANDISSEMENT){
    ...
    if (posXok && posY){
        ...
        sprite.move(AGRANDISSEMENT*(largeurCarte-1)*TAILLE_ENTITE, 0);
    }
