...
public:
    ...
    */
    ...
    /**
    * \const void interactionTunnelHorizontaux(const TunnelHorizontal& t, sf::Sprite& sprite, int TAILLE_ENTITE, float AGRANDISSEMENT)
    ...
    */
    void interactionTunnelHorizontaux(const TunnelHorizontal& t, sf::Sprite& sprite, int TAILLE_ENTITE, float AGRANDISSEMENT);
