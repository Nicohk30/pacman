            ...
            case 2:
                ...
                if (nouvelleVie){
                    ...
                    if (sf::Keyboard::isKeyPressed(sf::Keyboard::A)){
                        fantome1.setEtatSeDeplacer(false);
                        fantome2.setEtatSeDeplacer(false);
                        fantome3.setEtatSeDeplacer(false);
                        fantome4.setEtatSeDeplacer(false);
                    }
                    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z)){
                        fantome1.setEtatSeDeplacer(true);
                        fantome2.setEtatSeDeplacer(true);
                        fantome3.setEtatSeDeplacer(true);
                        fantome4.setEtatSeDeplacer(true);
                    }
